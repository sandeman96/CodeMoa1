...
INSERT INTO MEMBER
VALUES('codeMoa111@mail.com', '$2a$10$UW3aeZWxx9IW3PYOkboaPO0GhbF3fHxyLe0j6hArQ6YVTlbuqnNES', '코드모아', '코모',  DEFAULT, DEFAULT, NULL, NULL, NULL, NULL);
...
CREATE TABLE BOARD (
   ...
   B_COUNT   NUMBER(10)   DEFAULT 0   NULL,
   B_STATUS   VARCHAR2(5)   DEFAULT 'Y'   NOT NULL,
   B_FIRST   VARCHAR2(1000)      NULL,
...
CREATE TABLE MESSAGE (
   ...
   MG_STATUS   VARCHAR2(10)   DEFAULT 'Y'   NOT NULL,
...
CREATE TABLE INTRODUCE (
	I_ID	VARCHAR2(100)		NOT NULL,
	I_EDU	VARCHAR2(1000)	DEFAULT ''	NULL,
    I_LOCATION	VARCHAR2(1000)	DEFAULT ''	NULL,
	I_SKILL	VARCHAR2(1000)	DEFAULT ''	NULL,
	I_NOTE	VARCHAR2(1000)	DEFAULT ''	NULL
);
...
ALTER TABLE INTRODUCE ADD CONSTRAINT INTRODUCE_MEMBER_ID
FOREIGN KEY (I_ID)
REFERENCES MEMBER (M_EMAIL);
