               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="moveTechQnA.bo" class="nav-link">
										<p>Q&A</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="moveTechTips.bo" class="nav-link">
										<p>Tips</p>
									</a>
								</li>
							</ul>
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="moveCommunityStudy.bo" class="nav-link">
										<p>Study</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="moveCommunityCalendar.bo" class="nav-link">
										<p>Calendar</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="moveCommunityJob.bo" class="nav-link">
										<p>Job</p>
									</a>
								</li>
							</ul>
