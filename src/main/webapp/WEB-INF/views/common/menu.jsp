					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="techqnalist.bo" class="nav-link"> Q&amp;A </a>
								</li>
								<li class="nav-item">
									<a href="techtipslist.bo" class="nav-link"> Tips </a>
								</li>
							</ul>
						</li>
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="communitystudy.bo" class="nav-link"> Study </a>
								</li>
								<li class="nav-item">
									<a href="communityjob.bo" class="nav-link"> Job </a>
								</li>
							</ul>
						</li>
