		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid mb-3">
					<h1 style="text-align: center; margin-bottom: 3rem;">{} 상세보기</h1>
					<div class="col-sm-12 btn" style="text-align: right;">
						<button type="button" class="btn btn-warning"
							onclick="location.href='updateBoardForm.bo'"
							style="font-size: 0.8rem; color: #939597; width: 7rem;">수정하기</button>
						<button type="button" class="btn btn-warning"
							onclick="location.href='deleteBoard.bo'"
					...
					<div class="card">
						...
						<div class="card-body">
							<textarea class="form-control"
								style="height: 50rem; resize: none; color: #939597;" readonly>내용</textarea>
						</div>
						<div class="card-body table-responsive p-0">
