				...
				<div class="card-header mb-4">
					...
					<form method="get" id="searchForm">
						<div class="col-1" style="display: inline-block; float: right;">
							<button type="submit" class="btn btn-warning float-right" id="searchBtn" style="font-size: 0.8rem; display: inline-block; color: #939597; width: 7rem;">검색</button>
						</div>
						<div class="col-3 mb-3" style="display: inline-block; float: right;">
							<div>
								<input class="effect-8" type="text" id="search" name="search" placeholder="검색어를 입력해주세요" value="${search}">
										...
										<c:if test="${b.bFirst eq 'Y' }">
											<tr style="font-weight: bold;">
												<td style="width: 50rem;">
													<span>
														<button type="button" class="btn-first-tag" onclick="location.href='boardList${boardName}.bo'">${tagName}</button>
														&nbsp;
													</span>
												...
												<td style="color: #f5825f;">
													<span>
														<i class="bi bi-hand-thumbs-up"></i>${ b.lCount }</span>
												</td>
												<td style="color: #f5825f;">
													<span>
			...
			$('#searchBtn').click(
					function() {
						...
						$('#searchForm').attr("action",
								"boardList${boardName}.bo?search=${search}");
						return true;
					});
		});
	</script>
