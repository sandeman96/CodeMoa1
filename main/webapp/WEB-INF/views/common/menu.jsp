					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item menu-open">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="${contextPath }/boardListFaq.bo" class="nav-link"> Q&amp;A </a>
								</li>
								<li class="nav-item">
									<a href="${contextPath }/boardListTips.bo" class="nav-link"> Tips </a>
								</li>
							</ul>
						</li>
						...
						<li class="nav-item">
							<a href="${contextPath }/boardListCalendar.bo" class="nav-link">
...
<!-- 						<li class="nav-item">
				...
				<c:if test="${ loginUser != null }">
					<a href="${contextPath }/logout.me" id="logoutBtn" class="nav-link">
						&nbsp;&nbsp;
