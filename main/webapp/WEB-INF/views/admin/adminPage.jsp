...
<body class="hold-transition sidebar-mini layout-fixed">
   ...
   <div class="wrapper">
      ...
      <aside class="main-sidebar elevation-4" style="background-color: bisque;">
         <!-- Brand Logo -->
        ...
        <table class="jsgrid-table">
        	...
        	<div class="jsgrid-grid-body" style="height: 350px;"><table class="jsgrid-table">
        		...
        		<c:forEach var="m" items="${ mList }">
        			<tr class="jsgrid-row">
        				<td class="jsgrid-cell" style="width: 250px;">${ m.mName }</td>
        				<td class="jsgrid-cell jsgrid-align-right" style="width: 250px;">${ m.mPw }</td>
        				<td class="jsgrid-cell" style="width: 250px;">${ m.mPw }</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;">China</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;">China</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;"><input type="checkbox" disabled=""></td>
        			</tr>
        		</c:forEach>
        			<tr class="jsgrid-alt-row">
        				<td class="jsgrid-cell" style="width: 250px;">Connor Johnston</td>
        				<td class="jsgrid-cell jsgrid-align-right" style="width: 250px;">73</td>
        				<td class="jsgrid-cell" style="width: 250px;">Ap #370-4647 Dis Av.</td>
        				<td class="jsgrid-cell" style="width: 250px;">Ap #370-4647 Dis Av.</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;">Russia</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;">
        ...
        <table class="jsgrid-table">
        	...
        	<div class="jsgrid-grid-body" style="height: 350px;"><table class="jsgrid-table">
        		<tbody>
        			...
        			<tr class="jsgrid-row">
        				<td class="jsgrid-cell" style="width: 250px;">${ m.mName }</td>
        				<td class="jsgrid-cell jsgrid-align-right" style="width: 250px;">${ mList.mId }</td>
        				<td class="jsgrid-cell" style="width: 250px;">${ member.mPw }</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;">China</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;">China</td>
        				<td class="jsgrid-cell jsgrid-align-center" style="width: 250px;"><input type="checkbox" disabled=""></td>
        			</tr>
